            ...
            <div class="card">
                ...
                <form action="{{ route('member.update')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="mi" class="col-md-2 col-form-label text-md-right">M.I.</label>

                            <div class="col-md-8">
                                <input id="mi" type="text" class="form-control @error('mi') is-invalid @enderror" name="mi" value="{{ $users->mi }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="course" type="text" class="form-control @error('course') is-invalid @enderror" name="course" value="{{ $users->course }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="background" class="col-md-2 col-form-label text-md-right">Background</label>

                            <div class="col-md-8">
                                <input id="background" type="text" class="form-control @error('background') is-invalid @enderror" name="background" value="{{ $users->background }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="image_file" class="col-md-2 col-form-label text-md-right">Photo Image</label>

                            <div class="col-md-8">


<img class="img-fluid" src="{!! asset('img/' . $users->image_file) !!}">
